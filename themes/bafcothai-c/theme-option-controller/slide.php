...
switch ($checkPost) {
    ...
    case "get":
        ...
        <input type="hidden" id="slideID" name="slideID" value="<?php echo $_POST['slideID']; ?>"/>
...
<script type="text/javascript">
    ...
    function validate()
    {
        ...
        if ($jConflict('#slideDescription').val() == "Description"){
            $jConflict('#slideDescription').val("");
        }
        if ($jConflict('#slideLink').val() == "Link Slide"){
            $jConflict('#slideLink').val("");
        }
        return true;
    }
</script>
